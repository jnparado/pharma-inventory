import { stockIn, stockOut } from "@/app/actions";
import {
  getProducts,
  getSuppliers,
  getTransactions,
    ...
    <>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Card title="Stock in — receive a batch">
          <form action={stockIn} className="grid gap-4 sm:grid-cols-2">
        ...
        <Card title="Stock out — dispense / sell">
          <form action={stockOut} className="grid gap-4">
            <div>
