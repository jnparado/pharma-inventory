...
export function TopBar({
  ...
  return (
    <header className="sticky top-0 z-20 flex items-center justify-between border-b border-slate-200 bg-white px-4 py-3 md:px-8">
      <div className="flex flex-1 items-center gap-3">
        ...
        <div className="relative hidden max-w-md flex-1 sm:block">
          ...
          <input
            ...
            className="w-full rounded-xl border border-slate-200 bg-slate-50 py-2 pl-10 pr-4 text-sm placeholder:text-slate-400 focus:border-teal-300 focus:outline-none focus:ring-2 focus:ring-teal-100"
          />
        </div>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative" ref={userRef}>
          <button
            ...
            className="flex items-center gap-2.5 rounded-xl border border-slate-100 py-1 pl-1 pr-3"
          >
            <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-teal-100 text-sm font-semibold text-teal-700">
              {initials}
            </div>
